						...
						<div class="12u">
							...
							<!-- Content -->
								<article id="content">
									<header>
										<h2>Welcome!</h2>
										<span>MOOCentral is designed to enhance your learning experience by easily providing you with online courses.</span>
									</header>
									...
									<p>We at MOOCentral came together to design a website that gathers all the courses and
									the information associated with them to a central database which one can easily search.
									The course data has been aggregated from 8 different MOOC websites:<br>
									Coursera, Udacity, Canvas, Open2Study, Iversity, FutureLearn, EdX, NovoED</p>
									<p>Along with being able to search for all the aggregated courses from the various sites
									creating an account allows you to keep track, rate, and review the courses.</p>
									<p>We hope you will sign up for an account on MOOCentral to start your path to an
									easier and better learning experience. Thank You!</p>
								</article>
