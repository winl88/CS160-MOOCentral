...
$columns = array(
	array( 
		...
		'formatter' => function( $d, $row ) {
			return '<td><button id="favorites" onclick="addToFavorites(' . $d . ', 1)">Add</button><button onclick="viewReviews(' . $d . ')">Reviews</button></td>';
		} 
	),
	array( 
		'db' => 'course_image',
	...
	array(
		...
		'dt' => 2,
		'formatter' => function( $d, $row ) {
			return '<td width="500px"><a href="' . 'page.php?ref=' . $row['course_id'] . '" target="_blank">' . $row['title'] . '</a></td>';
		} 
	),
	array(
		'db' => 'rate',
